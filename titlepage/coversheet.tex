...
\def\title{Modulanmeldung für die Zentralisierung in der HTL-Leonding}
%
...
%
\def\nameone{Emir Bajramovic}
\def\nametwo{Sandor Debnar}
\def\namethree{Thomas Straßhofer}
%
% enter the name of the supervisor 
%
\def\firstreferee{Robert Stöttinger <--Titel feh}
%
